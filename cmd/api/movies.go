...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	input.Filters.Page = app.readInt(qs, "page", 1, v)           //default
	input.Filters.PageSize = app.readInt(qs, "page_size", 20, v) //default

	input.Filters.Sort = app.readString(qs, "sort", "id") //default
